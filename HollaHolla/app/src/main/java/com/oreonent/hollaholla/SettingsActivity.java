    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK){
                ...
                StorageReference filePath = UserProfileImageRef.child(currentUserID + ".jpeg");

                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(SettingsActivity.this, "Success. Profile picture has been set", Toast.LENGTH_LONG).show();
                            ...
                            RootRef.child("Users").child(currentUserID).child("image").setValue(downloadUrl)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()){
                                                Toast.makeText(SettingsActivity.this, "Profile picture successfully saved", Toast.LENGTH_LONG).show();
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if ((dataSnapshot.exists()) && (dataSnapshot.hasChild("name") && (dataSnapshot.hasChild("image")))){
                            ...
                            //Retrieving profile picture using Picasso library
                            ...
                            //userName.setVisibility(View.INVISIBLE);
                            Toast.makeText(SettingsActivity.this, "Set and update your profile information", Toast.LENGTH_LONG).show();
                        }
                    }
